...
import { Calendar, Users, Clock, CheckCircle, User, Phone, MapPin } from 'lucide-react'

const DoctorDashboard = () => {
  const { t } = useLanguage()
  const { currentUser, getDoctorAppointments, updateAppointmentStatus, workers } = useUser()
